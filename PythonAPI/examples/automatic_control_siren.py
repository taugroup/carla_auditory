...
from pull_over_agent import PullOverAgent
from real_time_test import record_2_and_classify
...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        self._info_text = [
            ...
            '',
            'Siren Detection:' , (isDetecting),
            '',
            'Emergency Vehicle:' , (vehiclePresent),
            '']
...
def game_loop(args):
    ...
    try:
        ...
        agent = PullOverAgent(world.player)
