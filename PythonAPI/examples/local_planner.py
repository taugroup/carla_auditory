...
class LocalPlanner(object):
    ...
    def set_global_plan(self, current_plan, stop_waypoint_creation=True, clean_queue=True,siren = False):
        """
        ...
        #print("new plan: " + str(new_plan_length)+ "  queue: " + str(self._waypoints_queue.maxlen))
        ...
        #remove this if else if you want it to only go in right lane.
        if(siren):
            for elem in current_plan:
                elem1 = (elem[0].get_right_lane(),RoadOption.CHANGELANERIGHT)
                self._waypoints_queue.append(elem1)
        else:
            for elem in current_plan:
                #print("add")
